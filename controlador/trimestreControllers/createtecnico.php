...
if (empty($ficha_fechas)) {
  ...
  <script>
      ...
      window.location = "../../vista/crear/tecnico_crear_trim.php";
  </script>';
  exit();
}
...
$trim_III="3";
 ...
 $querys=mysqli_query($conn,"UPDATE ficha set `estatus_trim`=1 where ID_F='$ficha_fechas'");
  ...
  // INSERT INTO `tb_trimestre` (`id_T`, `Trim_date_Inc`, `Trim_date_fin`, `Trimestre`, `id_fch`, `instructor_id`, `estatus_trim_H`, `año_trim`, `periodo_trim`) 
  //VALUES (NULL, '2023-03-09', '2023-03-16', '2', '12', '10', '1', '2', '2');
