...
?>
<input type="hidden" name="redirect" value="insped2">
              ...
              ?>
                <td>
                  ...
                  if (isset($row) && !empty($row)) {
                    ...
                    <input type="hidden" name="periodo" value="2"> <!-- asegúrate que $pedis tiene el id del periodo -->
                  ...
                  while ($extra = mysqli_fetch_assoc($resultExtras)) {
                    ...
                    <div style="color:blue; font-size:0.85em; margin-top:4px;">
                        ...
                        <form action='../../controlador/HorariosController/eliminar_horas_extra.php'
                            ...
                            <input type='hidden' name='redirect' value='insped2.php?instructor=<?php echo $id_ins; ?>'>
                            <button type='submit' class='btn btn-outline-dark btn-sm'
...
FROM horarios 
WHERE instructor = $id_ins AND period_fk = 2";
