...
?>
<input type="hidden" name="redirect" value="insped4">
              ...
              ?>
                <td>
                  ...
                  if (isset($row) && !empty($row)) {
                    ...
                    <input type="hidden" name="periodo" value="4"> <!-- asegúrate que $pedis tiene el id del periodo -->
                  ...
                  while ($extra = mysqli_fetch_assoc($resultExtras)) {
                    ...
                    <div style="color:blue; font-size:0.85em; margin-top:4px;">
                        ...
                        <form action='../../controlador/HorariosController/eliminar_horas_extra.php'
                            ...
                            <input type='hidden' name='redirect' value='insped4.php?instructor=<?php echo $id_ins; ?>'>
                            <button type='submit' class='btn btn-outline-dark btn-sm'
...
FROM horarios 
WHERE instructor = $id_ins AND period_fk = 4";
...
$nombres_tipo = [
  ...
  'Proyecto dirección general' => 'Horas proyecto Dirección general',
  'Diseño curricular' => 'Horas Diseño curricular',
];
?>
