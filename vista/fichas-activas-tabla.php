...
<div>
  <div class="row">
    <div class="col-lg-12 mx-auto">
      <div class="container">
      <?php
        $tablaf1 = "SELECT * FROM ficha,programa,tb_trimestre,nivel_forma,jornada  
              ...
              <tbody>
                ...
                ?>
                  ...
                  <td><?php echo $fcon1['Nº ficha']; ?></td>
                    ...
                    <td><?php echo $fcon1["Nivel_for"]; ?> </td>
                    <td><?php echo $fcon1["tipo_jornada"]; ?></td>
                    <td><?php echo $fcon1["Trimestre"]; ?></td>
                    <td>
                      <div class="btn-group">
                        <button class="btn btn-dark btn-sm" onclick="window.open('horarios_ficha.php?ficha=<?php echo $fcon1['ID_F']?>&pro=<?php echo $fcon1['id_program']?>','_Self')">Horario</button>
                        ...
                        <a href="../controlador/deleteF.php?eliF=<?php echo $fcon1['ID_F'] ?>"><button type="submit" class="btn btn-danger btn-sm" onclick="return elif()"><i class="bi-trash"></i></button></a>
                      </div>
                    </td>
                  </tr>
                <?php
