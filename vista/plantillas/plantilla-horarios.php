...
include("formulario_ins.php");
include("extra-horario.php"); 
...
<body>
  ...
  <a href="../horarios.php" style="color: white;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-4 pb-4 mb-4 d-flex">
            ...
            <div class="info">
              <a href="" id="myModal" data-toggle="modal" data-target="#myModal" style="color:white;">Crear Horario </a>
            </div>
  ...
  <div class="info">
    <a href="" id="myModalExtraBtn" data-toggle="modal" data-target="#myModalExtra" style="color:white;">
      Agregar Horas Extra
    </a>
  </div>
</div>
...
<div class="user-panel mt-4 pb-4 mb-4 d-flex">
  ...
  <div class="info">
    <a href="" data-toggle="modal" data-target="#modalObservaciones" style="color:white;">
